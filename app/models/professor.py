...
class Professor(db.Model):
    ...
    professors_dni = db.Column(db.String(9))
    professors_address = db.Column(db.String(255))
    professors_city = db.Column(db.String(50))
    professors_postal = db.Column(db.Integer)
    professors_number_card = db.Column(db.String(16))
    professors_exp_date = db.Column(db.String(5))
    professors_cvc = db.Column(db.Integer)
